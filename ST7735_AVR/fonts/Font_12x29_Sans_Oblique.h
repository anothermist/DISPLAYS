const uint8_t Font_12x29_Sans_ObliqueBitmaps[] PROGMEM = {
...
const GFXglyph Font_12x29_Sans_ObliqueGlyphs[] PROGMEM = {
  {     0,   0,   0,   7,    0,    1 },   // 0x20 ' '
  {     0,   6,  18,   7,    3,  -17 },   // 0x21 '!'
  {    14,   6,   6,   9,    4,  -16 },   // 0x22 '"'
...
const GFXfont Font_12x29_Sans_Oblique PROGMEM = {
  (uint8_t  *)Font_12x29_Sans_ObliqueBitmaps,
  (GFXglyph *)Font_12x29_Sans_ObliqueGlyphs,
  0x20, 0x7E, 29 };
