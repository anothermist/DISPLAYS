const uint8_t Font_12x29_Sans_BoldBitmaps[] PROGMEM = {
...
const GFXglyph Font_12x29_Sans_BoldGlyphs[] PROGMEM = {
  {     0,   0,   0,   7,    0,    1 },   // 0x20 ' '
  {     0,   4,  17,   8,    3,  -16 },   // 0x21 '!'
  {     9,  10,   6,  11,    1,  -17 },   // 0x22 '"'
...
const GFXfont Font_12x29_Sans_Bold PROGMEM = {
  (uint8_t  *)Font_12x29_Sans_BoldBitmaps,
  (GFXglyph *)Font_12x29_Sans_BoldGlyphs,
  0x20, 0x7E, 29 };
