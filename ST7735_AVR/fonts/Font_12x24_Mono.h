const uint8_t Font_12x24_MonoBitmaps[] PROGMEM = {
...
const GFXglyph Font_12x24_MonoGlyphs[] PROGMEM = {
  {     0,   0,   0,  14,    0,    1 },   // 0x20 ' '
  {     0,   3,  15,  14,    6,  -14 },   // 0x21 '!'
  {     6,   8,   7,  14,    3,  -14 },   // 0x22 '"'
...
const GFXfont Font_12x24_Mono PROGMEM = {
  (uint8_t  *)Font_12x24_MonoBitmaps,
  (GFXglyph *)Font_12x24_MonoGlyphs,
  0x20, 0x7E, 24 };
