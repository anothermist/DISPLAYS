const uint8_t Font_9x22_SansBitmaps[] PROGMEM = {
...
const GFXglyph Font_9x22_SansGlyphs[] PROGMEM = {
  {     0,   0,   0,   5,    0,    1 },   // 0x20 ' '
  {     0,   2,  13,   6,    2,  -12 },   // 0x21 '!'
  {     4,   5,   4,   6,    1,  -12 },   // 0x22 '"'
...
const GFXfont Font_9x22_Sans PROGMEM = {
  (uint8_t  *)Font_9x22_SansBitmaps,
  (GFXglyph *)Font_9x22_SansGlyphs,
  0x20, 0x7E, 22 };
