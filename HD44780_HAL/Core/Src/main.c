...
int main(void) {
	...
	char cc[] = { 0x00, 0x00, 0x0A, 0x00, 0x11, 0x0E, 0x00, 0x00,  // smiley
	...
	HD44780_SetPos(1, 1); HD44780_Data(0);
	HD44780_SetPos(1, 3); HD44780_Data(1);
	HD44780_SetPos(1, 5); HD44780_Data(2);
	HD44780_SetPos(1, 7); HD44780_Data(3);
	HD44780_SetPos(1, 9); HD44780_Data(4);
	HD44780_SetPos(1, 11); HD44780_Data(5);
	HD44780_SetPos(1, 13); HD44780_Data(6);
	HD44780_SetPos(1, 15); HD44780_Data(7);
