const uint8_t Font_3_TomThumb_ExtendedBitmaps[] PROGMEM = {
   0x00,                                /* 0x20 space */
...
const GFXglyph Font_3_TomThumb_ExtendedGlyphs[] PROGMEM = {
...
const GFXfont Font_3_TomThumb_Extended PROGMEM = {
