const uint8_t Font_9x18_MonoBitmaps[] PROGMEM = {
...
const GFXglyph Font_9x18_MonoGlyphs[] PROGMEM = {
  {     0,   0,   0,  11,    0,    1 },   // 0x20 ' '
  {     0,   2,  11,  11,    4,  -10 },   // 0x21 '!'
  {     3,   6,   5,  11,    2,  -10 },   // 0x22 '"'
  {     7,   7,  12,  11,    2,  -10 },   // 0x23 '#'
...
const GFXfont Font_9x18_Mono PROGMEM = {
  (uint8_t  *)Font_9x18_MonoBitmaps,
  (GFXglyph *)Font_9x18_MonoGlyphs,
  0x20, 0x7E, 18 };
