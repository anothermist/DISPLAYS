const uint8_t Font_12x29_Sans_Bold_ObliqueBitmaps[] PROGMEM = {
...
const GFXglyph Font_12x29_Sans_Bold_ObliqueGlyphs[] PROGMEM = {
  {     0,   0,   0,   7,    0,    1 },   // 0x20 ' '
  {     0,   7,  17,   8,    3,  -16 },   // 0x21 '!'
...
const GFXfont Font_12x29_Sans_Bold_Oblique PROGMEM = {
  (uint8_t  *)Font_12x29_Sans_Bold_ObliqueBitmaps,
  (GFXglyph *)Font_12x29_Sans_Bold_ObliqueGlyphs,
  0x20, 0x7E, 29 };
