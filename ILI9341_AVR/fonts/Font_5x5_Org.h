const uint8_t Font_5x5_OrgBitmaps[] PROGMEM = {
...
const GFXglyph Font_5x5_OrgGlyphs[] PROGMEM = {
  {     0,   0,   0,   6,    0,    1 },   // 0x20 ' '
  {     0,   1,   5,   2,    0,   -4 },   // 0x21 '!'
  {     1,   3,   1,   4,    0,   -4 },   // 0x22 '"'
  {     2,   5,   5,   6,    0,   -4 },   // 0x23 '#'
...
const GFXfont Font_5x5_Org PROGMEM = {
  (uint8_t  *)Font_5x5_OrgBitmaps,
  (GFXglyph *)Font_5x5_OrgGlyphs,
  0x20, 0x7E, 7 };
