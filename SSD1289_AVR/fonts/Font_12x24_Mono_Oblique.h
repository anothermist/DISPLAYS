const uint8_t Font_12x24_Mono_ObliqueBitmaps[] PROGMEM = {
...
const GFXglyph Font_12x24_Mono_ObliqueGlyphs[] PROGMEM = {
  {     0,   0,   0,  14,    0,    1 },   // 0x20 ' '
  {     0,   4,  15,  14,    6,  -14 },   // 0x21 '!'
  {     8,   8,   7,  14,    5,  -14 },   // 0x22 '"'
...
const GFXfont Font_12x24_Mono_Oblique PROGMEM = {
  (uint8_t  *)Font_12x24_Mono_ObliqueBitmaps,
  (GFXglyph *)Font_12x24_Mono_ObliqueGlyphs,
  0x20, 0x7E, 24 };
