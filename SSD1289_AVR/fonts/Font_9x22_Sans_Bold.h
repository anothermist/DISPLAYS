const uint8_t Font_9x22_Sans_BoldBitmaps[] PROGMEM = {
...
const GFXglyph Font_9x22_Sans_BoldGlyphs[] PROGMEM = {
  {     0,   0,   0,   5,    0,    1 },   // 0x20 ' '
  {     0,   3,  13,   6,    2,  -12 },   // 0x21 '!'
  {     5,   7,   5,   9,    1,  -12 },   // 0x22 '"'
...
const GFXfont Font_9x22_Sans_Bold PROGMEM = {
  (uint8_t  *)Font_9x22_Sans_BoldBitmaps,
  (GFXglyph *)Font_9x22_Sans_BoldGlyphs,
  0x20, 0x7E, 22 };
