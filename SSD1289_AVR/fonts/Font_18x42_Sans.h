const uint8_t Font_18x42_SansBitmaps[] PROGMEM = {
...
const GFXglyph Font_18x42_SansGlyphs[] PROGMEM = {
  {     0,   0,   0,   9,    0,    1 },   // 0x20 ' '
  {     0,   3,  26,  12,    4,  -25 },   // 0x21 '!'
  {    10,   9,   9,  12,    1,  -24 },   // 0x22 '"'
...
const GFXfont Font_18x42_Sans PROGMEM = {
  (uint8_t  *)Font_18x42_SansBitmaps,
  (GFXglyph *)Font_18x42_SansGlyphs,
  0x20, 0x7E, 42 };
