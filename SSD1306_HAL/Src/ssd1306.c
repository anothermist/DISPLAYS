...
inline static void SSD1306_Command(uint8_t reg, uint8_t data)
{
	...
	dt[0] = reg;
	dt[1] = data;
	HAL_I2C_Master_Transmit(&SSD1306_I2C, SSD1306_TWI_ADDRESS, dt, 2, 10);
}
...
static void LCD_Char(int16_t x, int16_t y, const GFXglyph *glyph, const GFXfont *font, uint8_t size, SSD1306_COLOR_t color)
{
