const uint8_t Font_16x16_NadianneBitmaps[] PROGMEM = {
...
const GFXglyph Font_16x16_NadianneGlyphs[] PROGMEM = {
  { 0, 0, 0, 16, 0, 0 },	// char32
...
const GFXfont Font_16x16_Nadianne PROGMEM = {
 (uint8_t *)Font_16x16_NadianneBitmaps,
 (GFXglyph *)Font_16x16_NadianneGlyphs,
 32, 126, 16};
