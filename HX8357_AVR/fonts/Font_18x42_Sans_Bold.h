const uint8_t Font_18x42_Sans_BoldBitmaps[] PROGMEM = {
...
const GFXglyph Font_18x42_Sans_BoldGlyphs[] PROGMEM = {
  {     0,   0,   0,  10,    0,    1 },   // 0x20 ' '
  {     0,   5,  25,  12,    4,  -24 },   // 0x21 '!'
...
const GFXfont Font_18x42_Sans_Bold PROGMEM = {
  (uint8_t  *)Font_18x42_Sans_BoldBitmaps,
  (GFXglyph *)Font_18x42_Sans_BoldGlyphs,
  0x20, 0x7E, 42 };
