const uint8_t Font_12x29_SansBitmaps[] PROGMEM = {
...
const GFXglyph Font_12x29_SansGlyphs[] PROGMEM = {
  {     0,   0,   0,   6,    0,    1 },   // 0x20 ' '
  {     0,   2,  18,   8,    3,  -17 },   // 0x21 '!'
  {     5,   6,   6,   8,    1,  -16 },   // 0x22 '"'
...
const GFXfont Font_12x29_Sans PROGMEM = {
  (uint8_t  *)Font_12x29_SansBitmaps,
  (GFXglyph *)Font_12x29_SansGlyphs,
  0x20, 0x7E, 29 };
